...
def analytics_overview():
    ...
    try:
        from database.operations import get_all_students, get_all_data
        from services.reports import reports_service
...
@api_bp.route('/api/analytics/trends')
...
@api_bp.route('/api/analytics/late-arrivals')
...
@api_bp.route('/api/analytics/courses')
...
@api_bp.route('/api/analytics/weekly-patterns')
...
@api_bp.route('/api/analytics/top-performers')
...
@api_bp.route('/api/analytics/issues')
